...
?>
<?php echo e(Form::open(['url' => 'assetacquisition', 'method' => 'post'])); ?>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select name="asset_acquisition_type_id" id="asset_acquisition_type_id" class="form-control select">
                    <option value=""><?php echo e(__('Select Asset Acquisition Type')); ?></option>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('device_number', null, ['class' => 'form-control', 'placeholder' => __('Enter asset number (eg Vehicle No)')])); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::text('return_on', null, ['class' => 'form-control d_week current_date', 'autocomplete' => 'off'])); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('reason', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Asset Acquisition Reason'), 'rows' => '3'])); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/hrm/resources/views/assetacquisition/create.blade.php ENDPATH**/ ?>