    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Appraisal')): ?>
        <?php if($appraisalDue == 'Y'): ?>
            <a href="#" data-url="<?php echo e(route('appraisal.create')); ?>" data-ajax-popup="true" data-size="lg"
                data-title="<?php echo e(__('Create New Appraisal')); ?>" data-bs-toggle="tooltip" title=""
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/hrm/resources/views/appraisal/index.blade.php ENDPATH**/ ?>