                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700;font-size:18px">{{ __('Subject : ') . 'MD department to send approval letter for a vacation or leave.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700;font-size:18px">{{ __('Dear Elsie,') }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                        <p style="margin: 10px 0;font-size:18px">A new
                                                                            leave application has been submitted and
                                                                            have been approved by Julia.</p>
                                                                        <p></p>
                                                                        <p></p>
                                                                        ...
                                                                        <p></p>
                                                                        <p></p>
                                                                        <p style="margin: 10px 0;font-size:18px">Please
                                                                            review the application to grant your final
                                                                            autorization at your earliest convenience.
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
                                                                                    style="font-weight:700;font-size:18px">{{ __('Best regards,') }}</b></i>
                                                                        </p>
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal"><b
                                                                                    style="font-weight:700;font-size:18px">{{ env('APP_NAME') }}</b></i>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
