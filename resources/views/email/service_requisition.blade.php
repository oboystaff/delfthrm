                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700;font-size:18px">{{ __('Subject : ') . 'HR department to send approval letter for service requisition.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700;font-size:18px">{{ __('Dear Julia,') }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;font-size:18px"> A new
                                                                            ...
                                                                            {{ $officeProperty->employee->name ?? '' }}.
                                                                            Please review the details at your earliest
                                                                            convenience.</p>
                                                                        <p></p>
                                                                        <p></p>
                                                                        ...
                                                                        <p style="margin: 10px 0;font-size:18px">
                                                                            <strong>Request
                                                                                Type:</strong>
                                                                            {{ $officeProperty->request_type }}
                                                                        </p>
                                                                        <p style="margin: 10px 0;font-size:18px">
                                                                            <strong>Request
                                                                                Dates:</strong>
                                                                            {{ $officeProperty->start_date }} to
                                                                            {{ $officeProperty->end_date }}
                                                                        </p>
                                                                        <p style="margin: 10px 0;font-size:18px">
                                                                            <strong>Accompanied By:</strong>
                                                                            {{ $officeProperty->accompany_by }}
                                                                        </p>
                                                                        <p style="margin: 10px 0;font-size:18px">
