                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700;font-size:18px">{{ __('Subject : ') . 'Service requisition request approval from the HR department.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700;font-size:18px">{{ __('Dear ' . $officeProperty->employee->name . ',') }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                                                                        <p style="margin: 10px 0;font-size:18px"> Your
                                                                            recent request for service requisition has
                                                                            been approved by the HR department.</p>
                                                                        <p></p>
                                                                        <p></p>
                                                                    </div>
                                                                </td>
